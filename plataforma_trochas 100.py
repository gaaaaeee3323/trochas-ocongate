...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.caption(
        "Panel de planificación técnica: visión general de toda la conservación vial programada, "
        "con sugerencia automática de fechas, alertas por temporada de lluvias y criticidad."
    )
    ...
    if intervenciones.empty:
        ...
        st.markdown("##### 📅 Diagrama de Gantt general — toda la programación de mantenimiento vial")
        st.caption("Incluye los 5 tipos de mantenimiento, todos los tramos y todas las intervenciones registradas hasta ahora.")
    ...
    # ════════════════════════════════════════════════════════════════════════
    # PARTE B — REGISTRO / EDICIÓN DE INTERVENCIÓN
    # ════════════════════════════════════════════════════════════════════════
    st.markdown("---")
    st.markdown("### ✍️ B. Registro de nueva intervención")
    ...
    if tramos.empty:
        st.info("Primero registra al menos un tramo en el módulo de Registro de Tramos.")
    else:
